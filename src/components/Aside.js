    ...
    return (
      <div className={styles.aside}>
        ...
        <ul className={styles.ul7}>
          {props.srv == 70 ? (
            <li style={styl}>
              <Link data-val="7" data-srv="70" onClick={props.handleclick}>
                Services
              </Link>
            </li>
          ) : (
          ...
          {props.srv == 71 ? (
            <li style={styl}>
              <Link data-val="7" data-srv="71" onClick={props.handleclick}>
                Imagine
              </Link>
            </li>
          ) : (
          ...
          {props.srv == 72 ? (
            <li style={styl}>
              <Link data-val="7" data-srv="72" onClick={props.handleclick}>
                Design
              </Link>
            </li>
          ) : (
          ...
          {props.srv == 73 ? (
            <li style={styl}>
              <Link data-val="7" data-srv="73" onClick={props.handleclick}>
                Develop
              </Link>
            </li>
          ) : (
